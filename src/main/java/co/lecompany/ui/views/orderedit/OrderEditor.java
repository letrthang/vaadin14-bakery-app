...
import static co.lecompany.ui.dataproviders.DataProviderUtil.createItemLabelGenerator;
...
import co.lecompany.backend.data.OrderState;
import co.lecompany.backend.data.entity.Order;
import co.lecompany.backend.data.entity.PickupLocation;
import co.lecompany.backend.data.entity.Product;
import co.lecompany.backend.data.entity.User;
import co.lecompany.backend.service.PickupLocationService;
import co.lecompany.backend.service.ProductService;
import co.lecompany.ui.crud.CrudEntityDataProvider;
...
import co.lecompany.ui.views.storefront.events.ReviewEvent;
import co.lecompany.ui.views.storefront.events.ValueChangeEvent;
